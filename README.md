...
# The convert section of the project allows user to chose custom amounts to convert between a primary currency of their choice and a secondary currency
# Finally I used sqlite because it is built into python and is easy(relatively) to implement in programs
